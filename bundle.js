...
require('../libs/jquery.pep.js');

require('../libs/jquery.infinitedrag.js');
...
(0, _jquery2.default)(document).ready(function () {
	...
	var wall = _jquery2.default.infinitedrag('#wall', { elementsWithInteraction: '.info, .get-info, .cv-press-info' }, {
		width: tileWidth,
		height: tileHeight,
	...
	(0, _jquery2.default)('.get-info').on('click', showInfo);
	(0, _jquery2.default)('.close-info').on('click', hideInfo);
	(0, _jquery2.default)('.close-cv-press-info').on('click', hideCVPressInfo);
	(0, _jquery2.default)('.home').on('click', centerTiles);
	(0, _jquery2.default)('.cv-press-link').on('click', showCVPress);

	function showInfo() {
		(0, _jquery2.default)('.info').addClass('show');
	}

	function showCVPress(e) {
		e.preventDefault();
		(0, _jquery2.default)('.cv-press-info').addClass('show');
	}

	function hideInfo() {
		(0, _jquery2.default)('.info').removeClass('show');
	}

	function hideCVPressInfo() {
		(0, _jquery2.default)('.cv-press-info').removeClass('show');
	}
...
},{"../libs/jquery.infinitedrag.js":2,"../libs/jquery.pep.js":3,"jquery":4}],2:[function(require,module,exports){
'use strict';
...
(function ($) {
  ...
  */
	var InfiniteDrag = function InfiniteDrag(draggable, draggable_options, tile_options) {
		...
		var _to = {
			...
			oncreate: function oncreate($element, i, j) {
				$element.text(i + "," + j);
			},
			on_aggregate: false,
			aggregate_time: 10
		...
		self.update_containment = function () {
			...
			var containment = [-_to.range_col[1] * _to.width + viewport_offset.left + viewport_draggable_width, -_to.range_row[1] * _to.height + viewport_offset.top + viewport_draggable_height, -_to.range_col[0] * _to.width + viewport_offset.left, -_to.range_row[0] * _to.height + viewport_offset.top];
		...
		var update_tiles = function update_tiles(dragged_pos) {
			...
			if (Math.abs(dragged_pos.left - last_cleaned_tiles.left) > _to.remove_buffer * _to.width || Math.abs(dragged_pos.top - last_cleaned_tiles.top) > _to.remove_buffer * _to.height) {
		...
		//-----------------------
		var remove_tiles = function remove_tiles(left, top) {
