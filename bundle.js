...
(0, _jquery2.default)(document).ready(function () {
	...
	var wall = _jquery2.default.infinitedrag('#wall', {}, {
		width: tileWidth,
		height: tileHeight,
		//range_col: [0,10],
		//range_row: [0, 10],
	...
	(0, _jquery2.default)('.content-container').on('click', showInfo);
